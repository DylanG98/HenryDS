...
select count(nombre) from carrera;   #cant carrera en Henry

select count(idAlumno) from alumno; #cant alumnos 

select idCohorte,count(idAlumno) from alumno group by idCohorte; #cant alumnos por cohorte
